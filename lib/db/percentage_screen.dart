...
class _PercentageScreenState extends State<PercentageScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_showResult) buildResultCard(), // Conditionally display result card
          ],
        ),
      ),
    );
  ...
  Widget buildRadioOptions() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        buildRadioListTile("Increase/decrease X by Y%",
        ...
        buildRadioListTile("X is Y percent of what number?",
